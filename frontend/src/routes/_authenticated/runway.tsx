              ...
              <Card className="p-5 sm:p-6 border border-primary/20 bg-gradient-to-br from-primary/10 via-card/35 to-card/20 shadow-md">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                  <div className="space-y-2 max-w-3xl">
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-primary">Decision Engine</p>
                  ...
                  {foodRoutine && (
                    <Badge variant="outline" className="w-fit shrink-0 border-primary/25 bg-primary/10 text-primary text-[10px] uppercase tracking-wider font-black px-2.5 py-1">
                      {foodRoutine.label}
                    </Badge>
                  )}
                </div>
                  ...
                  {absorbedFactors.map((factor: any) => (
                    <div key={factor.kind} className="rounded-xl border border-border/70 bg-surface/70 p-3 min-w-0">
                      ...
                      <p className="mt-1 text-base sm:text-lg font-black text-foreground tnum">
                        ...
                        {factor.daily_amount ? <span className="text-[10px] font-bold text-zinc-500">/day</span> : null}
                      </p>
                      <p className="mt-1 text-[10px] text-zinc-500 leading-snug line-clamp-2">{factor.detail}</p>
                    </div>
                  ))}
                </div>
              </Card>
              ...
              <Card className="p-5 sm:p-6 border border-border bg-card/25">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="space-y-1.5">
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-zinc-500">Meal Routine</p>
                  ...
                  <Badge variant="outline" className="w-fit border-border bg-surface text-[10px] uppercase tracking-wider font-black">
                ...
                <div className="mt-5 grid grid-cols-2 lg:grid-cols-4 gap-3">
                  <div className="rounded-xl border border-border/70 bg-surface/70 p-3">
                    <p className="text-[10px] font-black uppercase tracking-wider text-zinc-500">Food pace</p>
                    <p className="mt-1 text-lg font-black text-foreground tnum">{formatRs(foodRoutine.food_daily_pace ?? 0)}<span className="text-[10px] text-zinc-500">/day</span></p>
                    <p className="mt-1 text-[10px] text-zinc-500">{foodRoutine.cycle_food_count ?? 0} food logs this cycle</p>
                  </div>
                  <div className="rounded-xl border border-border/70 bg-surface/70 p-3">
                    <p className="text-[10px] font-black uppercase tracking-wider text-zinc-500">Suggested cap</p>
                    <p className="mt-1 text-lg font-black text-primary tnum">{formatRs(foodRoutine.recommended_daily_food_cap ?? 0)}<span className="text-[10px] text-zinc-500">/day</span></p>
                    <p className="mt-1 text-[10px] text-zinc-500">Aligned to safe/day</p>
                  </div>
                  <div className="rounded-xl border border-border/70 bg-surface/70 p-3">
                    ...
                    <p className="mt-1 text-[10px] text-zinc-500">{formatRs(foodRoutine.delivery?.spend ?? 0)} this cycle</p>
                  </div>
                  <div className="rounded-xl border border-border/70 bg-surface/70 p-3">
                    <p className="text-[10px] font-black uppercase tracking-wider text-zinc-500">Two-order switch</p>
                    <p className="mt-1 text-lg font-black text-pb-green tnum">{formatRs(foodRoutine.savings_if_replace_two_deliveries ?? 0)}</p>
                    <p className="mt-1 text-[10px] text-zinc-500">Potential runway recovery</p>
                  </div>
                </div>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="border-t border-border/40 pt-4 space-y-2">
                    <div className="flex items-center gap-1.5">
                      <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Budget Modes</span>
                      <TooltipProvider>
                        <UITooltip>
                  ...
                  <div className="border-t border-border/40 pt-4 space-y-3">
                    <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Smart what-if switches</span>
                    ...
                    {isSimulatedSafe ? (
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-[10px] opacity-80 mt-0.5">This sandbox setting runs out {daysLeftInCycle - simulatedDays} days early with a gap of {formatRs(simulatedGapPaise)}. Slow the daily pace or use a data-backed lever.</p>
                        </div>
                      </>
                    )}
                  </div>
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10 text-xs">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-zinc-500">{foodRoutine?.action?.detail ?? "Use routine meals before delivery becomes the default. This keeps daily food spend inside your safe runway limit."}</p>
                      </div>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-pb-amber/5 border border-pb-amber/10 text-xs">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-zinc-500">{decisionEngine?.summary ?? `Try to stay within ${formatRs(forecast.projection.safe_daily_spend)} per day to keep your runway healthy.`}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10 text-xs">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-zinc-500">{foodRoutine?.action?.detail ?? "Keep food pace predictable so runway can reserve enough for travel, exams, and shared-pool dues."}</p>
                      </div>
                    </div>
                  </>
                )}
              ...
              <Card className="p-6 border border-border md:col-span-5 bg-card/25 flex flex-col justify-between">
                ...
                {activeActionType === "ask_home" && actualAskHomeAmount > 0 && (
                  <div className="mt-4 rounded-xl border border-pb-red/20 bg-pb-red/5 p-4">
                    <p className="text-[10px] font-black uppercase tracking-wider text-pb-red">Shortfall amount</p>
                ...
                <div className="mb-5 flex flex-wrap gap-x-5 gap-y-2 border-y border-border/50 py-3">
                  {commitmentSummary.map((item) => (
                    <div key={item.key} className="min-w-[110px]">
                      <p className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold">{item.label}</p>
